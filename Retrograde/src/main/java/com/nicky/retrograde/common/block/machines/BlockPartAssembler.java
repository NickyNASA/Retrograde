...
public class BlockPartAssembler extends BlockMachineBase
{

	public BlockPartAssembler()
	{
		super(ItemNames.PART_ASSEMBLER, Material.IRON);
	}
	
	@Override
	public Item getItemDropped(IBlockState state, Random rand, int fortune)
	{
		return Item.getItemFromBlock(RetrogradeBlocks.partAssembler);
	}
	...
	{
		if(!world.isRemote){
			playerIn.openGui(Retrograde.instance, GuiTypes.PART_ASSEMBLER.ordinal(), world, pos.getX(), pos.getY(), pos.getZ());
		}
	...
	{
		return new TileEntityPartAssembler();
	}
	
	@Override
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	{
		ItemHelper.dropInventory(worldIn, (TileEntityPartAssembler)worldIn.getTileEntity(pos), pos);

...
public class BlockBlueprintTable extends BlockRetrograde
{
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	
	public BlockBlueprintTable()
	{
		super(ItemNames.BLUEPRINT_TABLE, Material.WOOD);
	...
	{
		return Item.getItemFromBlock(RetrogradeBlocks.blueprintTable);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(RetrogradeBlocks.blueprintTable);
	}
	...
	{
		if(!world.isRemote) {
			playerIn.openGui(Retrograde.instance, GuiTypes.BLUEPRINT_TABLE.ordinal(), world, pos.getX(), pos.getY(), pos.getZ());
		}
	...
	{
		TileEntityBlueprintTable tileentity = (TileEntityBlueprintTable)worldIn.getTileEntity(pos);
	...
	public static void setState(boolean active, World worldIn, BlockPos pos)
	{
		...
		worldIn.setBlockState(pos, state.withProperty(FACING, state.getValue(FACING)), 3);

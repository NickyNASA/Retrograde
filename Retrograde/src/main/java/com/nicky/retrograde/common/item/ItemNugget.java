...
public class ItemNugget extends ItemRetrograde implements IHasMeta
{
	public static MetalVariant[] types = MetalVariant.values();
	
	public ItemNugget()
	{
		super(ItemNames.NUGGET);
	...
	{
		return types[meta].getName() + "_nugget";
	}
	...
	{
		return "item." + types[stack.getItemDamage()].getName() + "_nugget";
	}
}

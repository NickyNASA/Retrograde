...
public class GuiElementUpgradeTab extends GuiElementBase
{
	...
	public GuiElementUpgradeTab(GuiContainer gui, TileEntity tile, int posX, int posY, int prevGuiID)
	{
		super(gui, posX, posY);
	...
	public void mouseClicked(int mouseX, int mouseY, int button)
	{
		if(this.hovered){
			...
			PacketHandler.network.sendToServer(new PacketChangeGui.ChangeGuiMessage(GuiTypes.UPGRADE_TAB.ordinal(), pos));
		}
	}
